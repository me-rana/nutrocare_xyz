...
label.btn input:checked+span {
 ...
 <div class="container-fluid">
    <div class="container-fluid">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title fw-semibold mb-4">Custom Page Create</h5>
          <div class="card mb-0">
            <div class="card-body p-4">
                ...
                <form action="{{ url('admin/custom-page/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea name="description" class="form-control" id="inp_editor1" cols="30" rows="10"></textarea>
                  </div>
